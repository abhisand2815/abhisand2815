...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a1f2e,100:161b22&height=250&section=header&text=Abhimanyu%20Singh&fontSize=58&fontColor=58A6FF&fontAlignY=38&animation=fadeIn&desc=Full%20Stack%20Dev%20%7C%20Computer%20Vision%20%7C%20AI%2FML%20Explorer&descSize=17&descColor=8B949E&descAlignY=58" width="100%"/>
...
graduating: 2028
focus: [Web Dev, Computer Vision, AI/ML, DSA]
currently_building: HIREMIND — AI Interview & Hiring Platform
currently_learning: Deep Learning, Probabilistic Modeling
clubs:
  - Bit By Bit Club — Co-Lead, Event Management
  - iCreate Club — Co-Lead
  - UX Club — Core Member
fun_fact: "300-day self-directed DSA streak, still counting"
```
...
<img src="https://skillicons.dev/icons?i=c,cpp,java,py,js,html,css,nodejs,django,mysql,mongodb,opencv,pytorch,git,vscode,figma&theme=dark" />
...
Pin your projects natively — go to **github.com/abhisand2815 → Customize your pins** and choose up to 6 repos. GitHub renders these automatically on your profile below this README, with live stars/forks/language, and it never breaks or shows a "repo not found" box the way hardcoded pin-card images do when a repo name is off by a character.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:161b22,50:1a1f2e,100:0d1117&height=120&section=footer" width="100%"/>
